...
export function EditPropertyForm({ property }: EditPropertyFormProps) {
  ...
  const [status, setStatus] = useState<'Acquisition' | 'Preparation' | 'Marketing' | 'Sold' | 'Lost'>(property.status)
      ...
      <Card>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Select 
                ...
                onValueChange={(value) => setStatus(value as 'Acquisition' | 'Preparation' | 'Marketing' | 'Sold' | 'Lost')}
              >
          ...
          <div className="space-y-2">
            ...
            <div className="mt-2">
              ...
              <p className="text-sm text-muted-foreground mt-2">
                Upload a cover image for the property. If none is provided, the existing image will be kept.
              </p>
            </div>
        ...
        <CardFooter className="flex justify-between">
          <Button variant="outline" type="button" asChild>
            <Link href={`/app/properties/${property.id}`}>Cancel</Link>
          </Button>
